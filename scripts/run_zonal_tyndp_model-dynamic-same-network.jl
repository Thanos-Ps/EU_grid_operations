...
starting_temperature = 75                                        # setting the initial cable temperature at the start of the simulation      
cable_id = [16,92]                                               # examining the effect on the original network
