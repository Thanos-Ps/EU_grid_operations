...
# This variable is only used by the loops to sweep the simulation time selected from the temporal sampling.
prediction_horizon = 6

# Inputs for temporal sampling.
...
# Define capacities of branches in offshore grid. Units: in p.u. with base value 100 MVA
cable_capacity = 15
converter_capacity = 30      

# Add the offshore grid to compare with original grid (effect on obj fun)
